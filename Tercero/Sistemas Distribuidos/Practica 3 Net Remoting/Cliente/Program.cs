                        ...
                        if (almacenabierto == -1) {
                            ...
                            if (ig.NProductos(almacenabierto) < 1) {
                                ...
                                for (int i = 0; i < ig.NProductos(almacenabierto); i++) {
                                    Console.WriteLine(String.Format("{0,10} {1,25} {2,5} {3,10} {4,2}/{5,2}/{6,4}", ig.ObtenerProducto(almacenabierto, i).getCodProd(), ig.ObtenerProducto(almacenabierto, i).getNombre(),
                                            ig.ObtenerProducto(almacenabierto, i).getPrecio(), ig.ObtenerProducto(almacenabierto, i).getCantidad(), ig.ObtenerProducto(almacenabierto, i).getCaducidad().getDia(), 
                                            ig.ObtenerProducto(almacenabierto, i).getCaducidad().getMes(), ig.ObtenerProducto(almacenabierto, i).getCaducidad().getAnyo()));
                                }
                                Console.WriteLine("\n");
                            }
                        }
